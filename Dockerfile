...
RUN mkdir -p /go/src/github.com/adamsondelacruz/iotwifi
COPY . /go/src/github.com/adamsondelacruz/iotwifi

RUN CGO_ENABLED=0 go build -a -installsuffix cgo -o /go/bin/wifi /go/src/github.com/adamsondelacruz/iotwifi/main.go
